...
#define ADS_CONFIG_OS_NOBUSY                                                   \
  0x8000 // Device is not currently performing a conversion
#define ADS_CONFIG_OS_SINGLE_CONVERT                                           \
  0x8000 // Start a single conversion (when in power-down state)
#define ADS_CONFIG_OS_NO_EFFECT 0x0000 // No effect
#define ADS_CONFIG_MUX_MUL_0_1                                                 \
  0x0000 // Input multiplexer,AINP = AIN0 and AINN = AIN1(default)
#define ADS_CONFIG_MUX_MUL_0_3                                                 \
  0x1000 // Input multiplexer,AINP = AIN0 and AINN = AIN3
#define ADS_CONFIG_MUX_MUL_1_3                                                 \
  0x2000 // Input multiplexer,AINP = AIN1 and AINN = AIN3
#define ADS_CONFIG_MUX_MUL_2_3                                                 \
  0x3000 // Input multiplexer,AINP = AIN2 and AINN = AIN3
...
#define ADS_CONFIG_MODE_CONTINUOUS                                             \
  0x0000 // Device operating mode:Continuous-conversion mode
#define ADS_CONFIG_MODE_NOCONTINUOUS                                           \
  0x0100 // Device operating mode：Single-shot mode or power-down state
         // (default)
...
#define ADS_CONFIG_COMP_MODE_TRADITIONAL                                       \
  0x0000 // Comparator mode：Traditional comparator (default)
#define ADS_CONFIG_COMP_POL_LOW                                                \
  0x0000 // Comparator polarity：Active low (default)
...
#define ADS_CONFIG_COMP_QUE_NON                                                \
